...
CONFIG="${WOFI_CONFIG:-$HOME/.config/wofi/scripts/powermenu/config}"
STYLE="${WOFI_STYLE:-$HOME/.config/wofi/scripts/powermenu/style.css}"

# Wofi commands
wofi_command="wofi --show dmenu --conf ${CONFIG} --style ${STYLE} --width=400 --height=55"
